  ...
  return (
    <header className='max-w-[1280px] w-full p-[15px] mx-auto flex items-center justify-between mt-6 bg-white lg:px-[150px] rounded-full shadow-[0px_2px_83.95px_0px_rgba(0,0,0,0.2)] py-3'>
      ...
      <div className='flex items-center space-x-4'>
        <button className='flex cursor-pointer items-center gap-3 px-3 border border-gray-300 py-2 bg-gray-100 rounded-full'>
          <Image
        ...
        <Link
          href='/#'
          className='flex items-center gap-2 cursor-pointer text-black font-bold px-4 py-2 rounded-full border border-[#A3EED6] bg-[#1AD598] hover:opacity-85 transition-all'
        >
