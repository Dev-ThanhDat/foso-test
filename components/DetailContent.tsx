  ...
  return (
    <div>
      ...
      <div className='relative mt-6'>
        ...
        ></Image>
        <p className='max-w-[85%] text-[var( --colorGray)] font-medium text-xl mx-auto w-full text-center'>
      ...
      <h3 className='mt-6 mb-5 font-bold text-base text-[var(--colorSecondary)]'>
      ...
      <ul className='mb-5'>
        <li className='list-disc ml-5 text-[var(--colorSecondary)]'>
          Seiri <span className='text-[var(--textPrimary)]'>(Ngăn nắp)</span>
        </li>
        <li className='list-disc ml-5 text-[var(--colorSecondary)] font-medium'>
          Seiso <span className='text-[var(--textPrimary)]'>(Sạch sẽ)</span>
        </li>
        <li className='list-disc ml-5 text-[var(--colorSecondary)] font-medium'>
          Seiton <span className='text-[var(--textPrimary)]'>(Trật tự)</span>
        </li>
        <li className='list-disc ml-5 text-[var(--colorSecondary)] font-medium'>
          Shitsuke <span className='text-[var(--textPrimary)]'>(Kỷ luật)</span>
        </li>
        <li className='list-disc ml-5 text-[var(--colorSecondary)] font-medium'>
          Seiketsu 
          <span className='text-[var(--textPrimary)]'>(Tiêu chuẩn hóa)</span>
        </li>
      </ul>
      <h3 className='mt-6 mb-5 font-bold text-base text-[var(--colorSecondary)]'>
      ...
      <h3 className='mt-6 mb-5 font-bold text-[var(--colorSecondary)]'>
      ...
      <div className='mb-6 border-l-4 border-[var(--colorSecondary)] pl-[30px] italic text-xl'>
        <p>
