...
const SideBanner = () => {
  return (
    <>
      <div className=' max-w-[366px] w-full mb-8 bg-gradient-to-tr rounded-2xl overflow-hidden from-[#013DA0] flex flex-col to-[var(--colorBlur)]'>
        <Image
      ...
      <div className='mb-8 bg-gradient-to-tr max-w-[366px] w-full rounded-2xl overflow-hidden from-[#013DA0] to-[var(--colorBlur)]'>
        <Image
