    ...
    <section className='mt-[72px] mb-[112px] relative'>
      ...
      <div className='text-center'>
        <h2 className='text-[64px] text-black leading-[100px]'>
          Blog{' '}
          <span className='text-transparent font-black bg-clip-text bg-gradient-to-r from-[#1AD598] via-[#A3EED6] to-[#1AD598]'>
            FOSO
          </span>{' '}
          –
        </h2>
        <h2 className='text-[64px] text-black relative inline-block'>
          ...
          <span className='font-black relative'>
            Mới Nhất
            <span className='absolute left-0 bottom-[5px] w-full h-[25px] bg-[#A3EED6] -z-10 rounded-md'></span>
          </span>
        </h2>
