...
const BlogDetail = () => {
  return (
    <section className='container pt-8 px-[15px] lg:px-0 relative'>
      ...
      <div className='flex  mt-[72px] flex-col md:flex-row gap-[48px] mb-[48px]'>
        <main className='flex-1 order-2 lg:order-1'>
          <span className='text-xs font-medium bg-blue-100 text-[#0F4F9E] px-2 py-1 rounded-full'>
            Quản Lý Sản Xuất
          </span>
          <h1 className='text-[var(--colorBlack)] my-4 font-extrabold text-4xl'>
            Quy trình 5S là gì? Cách ứng dụng hiệu quả nên biết
          </h1>
          <div className='flex items-center gap-5 justify-between mb-6 flex-col md:flex-row'>
            <div className='flex items-center gap-3'>
              <Link
                href={'/#'}
                className='p-4 rounded-full bg-white border border-[#F1F5F7]'
              >
                <Image
